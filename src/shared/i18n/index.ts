...
const translations: Record<Locale, Record<string, string>> = {
	ko: {
		...
		"search.aiNotice.body": "백엔드 프록시가 설정되면 발음 재생과 AI 예문이 자동으로 활성화돼요. 현재는 사전 검색만 이용할 수 있어요.",
	},
	en: {
		...
		"search.aiNotice.body": "Once the backend proxy is configured, pronunciation and AI examples will activate. For now, dictionary search works without them.",
	},
};
