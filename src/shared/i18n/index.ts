...
const translations: Record<Locale, Record<string, string>> = {
    ko: {
        ...
        "settings.label.recoveryAvailable": "이메일 OTP 재설정",
        "settings.label.recoveryPreview": "지원 안내",
    ...
    en: {
        ...
        "settings.label.recoveryAvailable": "Email OTP reset",
        "settings.label.recoveryPreview": "Support guidance",
